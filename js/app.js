...
document.querySelector('button.add_new').addEventListener('click', function(e) {
    let name = document.getElementById('good_name').value,
        ...
        count = document.getElementById('good_count').value;
...
function update_goods() {
    let result_price = 0,
        tbody = document.querySelector('.list');
    tbody.innerHTML = '';
    ...
    if (goods.length) {
        ...
        for (let i = 0; i < goods.length; i++) {
            ...
            <tr class='align-middle'>
                ...
                <td>${goods[i][3]}</td>
                <td><button class='goods_delete btn btn-danger' data-delete='${goods[i][0]}'>&#10006;</button></td>
                <td><button class='goods_delete btn btn-primary' data-goods='${goods[i][0]}'>&#10149;</button></td>
            </tr>
            `
            )
            if (goods[i][4] > 0) {
